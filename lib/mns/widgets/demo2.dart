  ...
  Widget build(BuildContext context) {
    ...
    return Container(
      ...
      child: Container(
        ...
        margin: const EdgeInsets.fromLTRB(25, 10, 25, 8),
        child: Column(
                ...
                return Row(
                  ...
                  children: [
                    ...List.generate(
                      4,
                      (innerIndex2) {
                        print(items[4 * innerIndex + innerIndex2]);
                        int o = 4 * innerIndex + innerIndex2;
                        dynamic t = items[o].image;
                        print(o);
                        return GestureDetector(
                          onLongPress: () {
                            globals.getGridViewItems(
                                context, items[4 * innerIndex + innerIndex2]);
                          },
                          onTap: () {
                            setState(() {
                              items[4 * innerIndex + innerIndex2].tapcount++;
                              if (items[4 * innerIndex + innerIndex2]
                                      .tapcount ==
                                  1) {
                                gb.li[gb.pq].addAll({'mns': gb.icons['mns']});
                                print('I am in moods');
                              }
                              print(
                                  items[4 * innerIndex + innerIndex2].tapcount);
                                ...
                                children: [
                                  Container(
                                    decoration: BoxDecoration(
                                      border:
                                          items[4 * innerIndex + innerIndex2]
                                                          .image ==
                                                      'guilty' &&
                                                  items[4 * innerIndex +
                                                              innerIndex2]
                                                    ...
                                                    : items[4 * innerIndex + innerIndex2]
                                                        ...
                                                        : items[4 * innerIndex + innerIndex2]
                                                                ...
                                                                items[4 * innerIndex + innerIndex2]
                                                                    ...
                                                                    2
                                                            ? Nanogon()
                                                            : items[4 * innerIndex + innerIndex2].tapcount == 2
                                                                ? Transform.translate(
                                                                    offset:
                                                                        Offset(
                                                                            0,
                                                                        ...
                                                                        child:
                                                                          ...
                                                                          child: Theme.of(context).brightness == Brightness.light
                                                                              ? Image.asset(
                                                                                  ...
                                                                                  fit: BoxFit.cover,
                                                                                  width: (MediaQuery.of(context).size.width - 50 - 10) / 4,
                                                                                  height: (MediaQuery.of(context).size.width - 50 - 10) / 4,
                                                                                )
                                                                              : Image.asset(
                                                                                  'assets/images/2121.png',
                                                                                  // color:
                                                                                  //     Color.fromRGBO(88, 88, 88, 1),
                                                                                  fit: BoxFit.cover,
                                                                                  width: (MediaQuery.of(context).size.width - 50 - 10) / 4,
                                                                ...
                                                                : items[4 * innerIndex + innerIndex2].image == 'guilty' && items[4 * innerIndex + innerIndex2].tapcount == 3
                                                                    ? Circle()
                                                                    : items[4 * innerIndex + innerIndex2].tapcount == 3
                                                                        ? Transform.translate(
                                                                            offset:
                                                                                Offset(0, -10),
                                                                            child:
