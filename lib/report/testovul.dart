...
class OvulTestPage extends StatefulWidget {
  var contx;
  OvulTestPage(contx) {
    this.contx = contx;
  }
  ...
  @override
  _OvulTestPageState createState() => _OvulTestPageState(contx);
}

class _OvulTestPageState extends State<OvulTestPage>
