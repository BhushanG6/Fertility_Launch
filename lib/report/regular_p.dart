...
class RegularPeriod extends StatefulWidget {
  @override
  _RegularPeriodState createState() => _RegularPeriodState();
}

class _RegularPeriodState extends State<RegularPeriod> {
  _RegularPeriodState() {
    this.latestprot = ['', ''];
    this.latestunprot = ['', ''];
    this.totalprcnt = 0;
