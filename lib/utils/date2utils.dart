...
class DateUtils2 {
  ...
  static List<Month> extractWeeks(DateTime minDate, DateTime maxDate) {
    ...
    //sunday=>saturday
    DateTime weekMaxDate = _findDayOfWeekInMonth(maxDate, 6);
    ...
    if (!lastDayOfWeek.isBefore(weekMaxDate)) {
      ...
      while (lastDayOfWeek.isBefore(weekMaxDate)) {
        ...
        if (week.isLastWeekOfMonth) {
          // if ((lastDayOfWeek.day == 31 ||
          //         lastDayOfWeek.day == 28 ||
          //         lastDayOfWeek.day == 29 ||
          //         lastDayOfWeek.day == 30) &&
          //     lastDayOfWeek.weekday == 7) {
          //   //daysPerMonth(year)[month - 1]
          //   weeks.add(Week(lastDayOfWeek.add(Duration(days:1)), lastDayOfWeek.add(Duration(days:1))));
          // }
  ...
  static DateTime _findDayOfWeekInMonth(DateTime date, int dayOfWeek) {
    ...
    DateTime f = date.add(Duration(days: 1));
...
extension DateUtilsExtensions on DateTime {
  ...
  int get daysInMonth => DateUtils2.daysPerMonth(year)[month - 1];
...
// extension DateUtils2Extensions on DateTime {
//   bool get isLeapYear {
//     bool leapYear = false;
