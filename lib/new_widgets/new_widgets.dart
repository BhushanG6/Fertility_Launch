...
import 'newsecondscreen.dart';

class NewSlider extends StatefulWidget {
  final int month;
  final int year;
  NewSlider(this.month, this.year);
  @override
...
class _NewSliderState extends State<NewSlider> {
  ...
  Widget build(BuildContext context) {
    ...
    _panelHeightClosed = MediaQuery.of(context).size.height * 0.48 + 37;
      ...
      child: Stack(
        ...
        children: <Widget>[
          SlidingUpPanel(
            ...
            maxHeight:
                // _maxHeight,
                isFirstScreen ? _maxHeight : _panelHeightOpen,
            minHeight:
                //  _minHeight,
                isFirstScreen ? _panelHeightClosed : _panelHeightOpen,
